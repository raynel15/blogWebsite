        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="page-heading">
                    @if($user->profile_name == null && $user->profile_description == null)
                        <h1><a href = "#close" class='forum-title' name = "abc" data-toggle="modal" data-target="#usermodal" style="color:white"><u>About Me</u></a></h1>
                    @else
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" name="profile-name" class="form-control" required>
                <label>Description</label>
                <textarea name="profile-description" class="form-control" rows="4" cols="50" required></textarea>
